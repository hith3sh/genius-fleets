...
/*
DROP TABLE IF EXISTS ai_document_processing CASCADE;
DROP TABLE IF EXISTS legal_document CASCADE;
DROP TABLE IF EXISTS staff_document CASCADE;
DROP TABLE IF EXISTS agreement CASCADE;
DROP TABLE IF EXISTS car_image CASCADE;
DROP TABLE IF EXISTS customer_document CASCADE;
DROP TABLE IF EXISTS fine_log CASCADE;
DROP TABLE IF EXISTS vehicle_contract CASCADE;
...
DROP TABLE IF EXISTS corporate_client CASCADE;
DROP TABLE IF EXISTS marketing_campaign CASCADE;
...
-- Employee table (with leave balance fields added for HR module)
...
-- Success message
SELECT 'Database schema migration completed successfully! All 22 tables created with constraints, indexes, and triggers.' AS result;