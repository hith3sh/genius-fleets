        ...
        <div class="section payment-info">
            ...
            <div class="info-grid">
                ...
                <div class="info-item">
                    ...
                    <div class="info-value">AED ${Number(costs.totalAmount || 0).toFixed(2)}</div>
                </div>
                <div class="info-item">
                    <div class="info-label">VAT (5%):</div>
                    <div class="info-value">AED ${Number(costs.vatAmount || 0).toFixed(2)}</div>
                </div>
            </div>
            <div class="total-amount">
                💳 Total Amount: AED ${Number(costs.finalAmount || 0).toFixed(2)}
            </div>
        </div>
          ...
          <CardContent className="p-8 space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-4 border rounded-lg">
                ...
                <p><strong>Subtotal:</strong> AED {Number(costs.totalAmount || 0).toFixed(2)}</p>
                <p><strong>VAT (5%):</strong> AED {Number(costs.vatAmount || 0).toFixed(2)}</p>
                <p className="font-bold text-lg mt-2"><strong>Total:</strong> AED {Number(costs.finalAmount || 0).toFixed(2)}</p>
              </div>
            </div>
             <div className="p-4 border rounded-lg">
