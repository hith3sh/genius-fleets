          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <p><strong>Subtotal:</strong> AED {Number(booking.total_amount || 0).toFixed(2)}</p>
                <p><strong>VAT (5%):</strong> AED {Number(booking.vat_amount || 0).toFixed(2)}</p>
                <p className="text-lg font-bold text-green-600"><strong>Total:</strong> AED {Number(booking.final_amount || 0).toFixed(2)}</p>
              </div>
            </div>
          </CardContent>
        </Card>
