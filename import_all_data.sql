-- Generated Import Script for Supabase
-- Run this script in your Supabase SQL Editor

BEGIN;

-- Import data for user_access
INSERT INTO user_access (user_email, accessible_modules) VALUES
  ...
  ('lalchempakathinal@gmail.com', ARRAY['Customers', 'Marketing', 'Leads', 'CorporateClients', 'Quotations', 'SalesPerformance', 'FleetStatus', 'FleetAnalyst', 'SalikFines', 'FleetManagement', 'DamageLogs', 'GPSTracking', 'FleetHealth', 'Contracts', 'HREmployees', 'HRLeaveRequests', 'HRAttendance', 'HRPayroll', 'Payments', 'TaxVAT', 'Inventory', 'Reports', 'Invoices', 'FinanceOverview', 'Expenses', 'Depreciation', 'VehicleImageLibrary', 'StaffDocuments', 'BusinessInfo', 'Branches', 'UserAccessRules', 'APISettings', 'AIDocumentProcessing', 'CustomerDocuments', 'VehicleDocuments', 'LegalDocuments', 'Dashboard', 'Bookings', 'MobileBooking', 'SalesOrders', 'PriceLists', 'Quotes', 'Products', 'Inquiries', 'Vehicles', 'FuelLog', 'Drivers', 'Maintenance', 'Attendance', 'Employees', 'Accounts', 'Documents', 'Templates', 'Payroll', 'LeaveManagement', 'User Access Rules', 'API Settings', 'Branches', 'Quotations']),
  ('mohsin57ali@gmail.com', ARRAY['Dashboard', 'Bookings', 'MobileBooking', 'Inquiries', 'Quotes', 'SalesOrders', 'Customers', 'Products', 'PriceLists', 'Vehicles', 'Drivers', 'Maintenance', 'FuelLog', 'VehicleDocuments', 'Employees', 'Payroll', 'Attendance', 'LeaveManagement', 'Invoices', 'Payments', 'Expenses', 'Accounts', 'Reports', 'Documents', 'Templates', 'BusinessInfo', 'UserAccessRules', 'APISettings', 'Branches']),
  ('mohsin57ali@gmail.com', ARRAY['Dashboard', 'Bookings', 'MobileBooking', 'Inquiries', 'Quotes', 'SalesOrders', 'Customers', 'Products', 'PriceLists', 'Vehicles', 'Drivers', 'Maintenance', 'FuelLog', 'VehicleDocuments', 'Employees', 'Payroll', 'Attendance', 'LeaveManagement', 'Invoices', 'Payments', 'Expenses', 'Accounts', 'Reports', 'Documents', 'Templates', 'BusinessInfo', 'UserAccessRules', 'APISettings', 'Branches']),
  ('roosewalt@gmail.com', ARRAY['MobileBooking', 'Dashboard', 'Bookings', 'Customers', 'Leads', 'Quotations', 'Marketing', 'CorporateClients', 'SalesPerformance', 'HREmployees', 'HRAttendance', 'HRPayroll', 'HRLeaveRequests', 'FleetStatus', 'FleetManagement', 'FleetHealth', 'FleetAnalyst', 'DamageLogs', 'Contracts', 'SalikFines', 'GPSTracking', 'FinanceOverview', 'Invoices', 'Payments', 'Expenses', 'Reports', 'TaxVAT', 'Depreciation', 'Inventory', 'VehicleImageLibrary', 'VehicleDocuments', 'CustomerDocuments', 'StaffDocuments', 'LegalDocuments', 'AIDocumentProcessing', 'BusinessInfo', 'UserAccessRules', 'APISettings', 'Branches']),
  ('hithesh0215@gmail.com', ARRAY['MobileBooking', 'Dashboard', 'Bookings', 'Customers', 'Leads', 'Quotations', 'Marketing', 'CorporateClients', 'SalesPerformance', 'FleetStatus', 'FleetManagement', 'FleetHealth', 'FleetAnalyst', 'DamageLogs', 'Contracts', 'SalikFines', 'GPSTracking', 'HREmployees', 'HRAttendance', 'HRPayroll', 'HRLeaveRequests', 'FinanceOverview', 'Invoices', 'Payments', 'Expenses', 'Reports', 'TaxVAT', 'Depreciation', 'Inventory', 'VehicleImageLibrary', 'VehicleDocuments', 'CustomerDocuments', 'StaffDocuments', 'LegalDocuments', 'AIDocumentProcessing', 'BusinessInfo', 'UserAccessRules', 'APISettings', 'Branches'])
ON CONFLICT DO NOTHING;


-- Import data for customer
INSERT INTO customer (name, email, phone, license_number, address, customer_type, status) VALUES
  ('John Smith', 'john.smith@email.com', '+971-50-123-4567', 'DL12345678', '123 Business Bay, Dubai, UAE', 'Individual', 'Active'),
  ('Roosewalt Pereira', 'roosewalt@gmail.com', NULL, NULL, NULL, 'Individual', 'Active'),
  ('Roosewalt Sabestian Pereira', 'blogger.pereira@gmail.com', '0562440200', NULL, NULL, 'Individual', 'Active'),
  ('Roosewalt Sabestian Pereira', 'roosewalt@gmail.com', '0562440200', NULL, NULL, 'Individual', 'Active'),
  ('Test booking', 'help@joboy.', '582628980', NULL, NULL, 'Individual', 'Active'),
  ('Test', 'test', 'Test', NULL, NULL, 'Individual', 'Active'),
  ('Majid ABdul', 'majid1212@gmail.com', '+971123456789', NULL, '903 Al Saud Bldg 2', 'Individual', 'Active'),
  ('Lal Sebastian', 'lalchempakathinal@gmail.com', '+971000000000', NULL, 'Street No. 25', 'Individual', 'Active'),
  ('Ahmed Khalid Al Mansoori', 'ahmed.mansoori@example.com', '+971502345678', NULL, 'Villa 12, Jumeirah 1, Dubai', 'Individual', 'Active'),
  ('Ahmed Khalid Al Mansoori', 'ahmed.mansoori@example.com', '+971502345678', NULL, 'Villa 12, Jumeirah 1, Dubai', 'Individual', 'Active'),
  ('Ahmed Khalid Al Mansoori', 'ahmed.mansoori@example.com', '502345678', 'DUB123456', 'Villa 12, Jumeirah 1, Dubai', 'Individual', 'Active'),
  ('Priya Ramesh Nair', 'priya.nair@example.com', '+971523456789', NULL, 'Apt 405, Bur Dubai, Dubai', 'Individual', 'Active'),
  ('Ahmed Khalid Al Mansoori', 'ahmed.mansoori@example.com', NULL, NULL, NULL, 'Individual', 'Active'),
  ('Gabesh Shah', 'gabesh@gmail.com', '+971502402200', NULL, 'Flat 111, Hasani 19', 'Individual', 'Active'),
  ('Ahmed Shah', 'as123@gmail.com', '+971562000200', 'ABC1234', 'Flat 111, Hasani 19
Doha Street', 'Individual', 'Active'),
  ('Ganesh Shah', 'Gshah12@gmail.com', '+971562440222', 'ABC1234', 'Flat 111, Hasani 19
Doha Street', 'Individual', 'Active'),
  ('Roman Bhat', 'roman111@gmail.com', '+971562440440', 'ABC1234', 'Flat 111, Hasani 19
Doha Street', 'Individual', 'Active'),
  ('ABC Xghhhh', 'abc@gmail.com', '+971562220222', 'ABC1234', 'Flat 111, Hasani 19
Doha Street', 'Individual', 'Active'),
  ('aaaaaaa', 'aaaaa@gmail.com', '+971555555555', NULL, 'Flat 111, Hasani 19
Doha Street', 'Individual', 'Active'),
  ('kkkk hhhhh', 'gggg@gmail.com', '+971562440022', 'ABC1234', 'Flat 111, Hasani 19
Doha Street', 'Individual', 'Active'),
  ('Michael Andrew Smith', 'michael.smith@example.com', NULL, NULL, NULL, 'Individual', 'Active'),
  ('Fatima Hassan El Sayed', 'fatima.elsayed@example.com', '+971567654321', 'DUB345678', 'Apt 902, Al Nahda, Dubai', 'Individual', 'Active'),
  ('Zhang Wei', 'zhang.wei@example.com', '+971583214567', 'DUB901234', 'International City, China Cluster, Dubai', 'Corporate', 'Active'),
  ('Ahmed Al Mansouri', 'ahmed.almansouri@email.com', '+971 50 123 4567', '12345678', 'Dubai Marina, Dubai, UAE', 'Individual', 'Active'),
  ('Sarah Johnson', 'sarah.johnson@email.com', '+971 55 234 5678', '87654321', 'Jumeirah Beach Residence, Dubai, UAE', 'Individual', 'Active'),
  ('Mohammed Hassan', 'mohammed.hassan@email.com', '+971 50 345 6789', '11223344', 'Al Barsha, Dubai, UAE', 'Individual', 'Active'),
  ('Emirates Business Solutions', 'contact@emiratesbiz.com', '+971 4 567 8900', NULL, 'Business Bay, Dubai, UAE', 'Corporate', 'Active'),
  ('Fatima Al Zahra', 'fatima.alzahra@email.com', '+971 56 456 7890', '55667788', 'Downtown Dubai, Dubai, UAE', 'Individual', 'Active'),
  ('Lexus Auto LLC', 'roosewalt@geniushands.ae', NULL, NULL, NULL, 'Individual', 'Active'),
  ('Amazon Corp', 'amazon@gmail.com', NULL, NULL, NULL, 'Individual', 'Active'),
  ('DDD trading LLC', 'ddd@gmail.com', NULL, NULL, NULL, 'Individual', 'Active'),
  ('Google enterprises', 'google@gmail.com', NULL, NULL, NULL, 'Individual', 'Active'),
  ('ABCD LLC', 'abvgalt@gmail.com', NULL, NULL, NULL, 'Individual', 'Active'),
  ('Google enterprises', 'ggggalt@gmail.com', NULL, NULL, NULL, 'Individual', 'Active'),
  ('Amazon Corp', 'vbbbsewalt@gmail.com', NULL, NULL, NULL, 'Individual', 'Active')
ON CONFLICT DO NOTHING;


-- Import data for vehicle
INSERT INTO vehicle (license_plate, make, model, variant_trim, year, vin, engine_number, transmission_type, fuel_type, color, chassis_number, body_type, odometer_reading, odometer_source, seating_capacity, number_of_doors, vehicle_class, gps_installed, status, location, assigned_branch, current_renter, purchase_date, purchase_price, current_market_value, lease_owned, leasing_company, insurance_provider, insurance_policy_number, insurance_expiry_date, salik_tag_number, registration_expiry_date, mortgage_loan_status, sold_date, sold_value, estimated_present_value, last_service_date, next_service_due_km, next_service_due_date, tyre_change_date, battery_replacement_date, service_provider, service_notes, accident_history, damage_notes, registration_copy, insurance_copy, emission_test, image_set_id, vehicle_photos, real_time_location, fuel_level, engine_status, battery_level, daily_rate, monthly_rate, health_rating, live_latitude, live_longitude, registration_date, country_of_origin, owner_name, tc_number, place_of_issue) VALUES
  ('P/61550', 'NISSAN', 'PATHFINDER', NULL, 2020, '5N1DR2AM9LC643661', NULL, 'Automatic', 'Petrol', 'WHITE', '5N1DR2AM9LC643661', 'Sedan', 150000, 'Manual', 7, 4, 'Economy', NULL, 'Available', 'Dubai', 'Al nahda', NULL, '2024-07-27', 65000.0, NULL, 'Owned', NULL, NULL, '2530004975', '2026-07-25', NULL, '2026-06-25', NULL, NULL, NULL, NULL, '2025-07-31', 10000, '2025-09-30', '2025-06-13', '2025-05-14', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ARRAY['https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/c62a4cc50_NISSANPATHFINDERWHITE2020.png'], NULL, NULL, NULL, NULL, 100.0, 2500.0, 'Good', NULL, NULL, '2026-06-25', 'AMERICA', 'MOHSIN ALI ZULIFQAR ALI', '2140113865', 'DUBAI'),
  ('F/20428', 'NISSAN', 'ALTIMA SE', 'SE', 2019, '1N4BL4DV0KC109577', NULL, 'Automatic', 'Petrol', 'BLUE', '1N4BL4DV0KC109577', 'Sedan', 450000, 'Manual', 5, 4, 'Economy', NULL, 'Available', 'Dubai', 'Al nahda', NULL, '2023-12-12', 45000.0, 40000.0, 'Owned', NULL, NULL, '2510034606', '2026-05-08', NULL, '2026-04-08', NULL, NULL, NULL, NULL, '2025-07-31', 15000, '2025-10-31', '2025-07-31', '2024-11-29', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ARRAY['https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/e4773b108_NissanSunnyBlue.png'], NULL, NULL, NULL, NULL, 50.0, 2000.0, 'Good', NULL, NULL, '2009-04-25', 'AMERICA', 'MOHSIN ALI ZULIFQAR ALI', '2140113865', 'DUBAI'),
  ('M/61477', 'NISSAN', 'VERSA', NULL, 2020, '3N1CN8EVXLL825586', NULL, 'Automatic', 'Petrol', 'SILVER', '3N1CN8EVXLL825586', 'Sedan', 300000, 'Manual', 5, 4, 'Economy', NULL, 'Rented', 'Dubai', 'Al nahda', NULL, '2023-11-08', 40000.0, 35000.0, 'Owned', NULL, NULL, '2566S30788', '2026-03-22', NULL, '2026-02-22', NULL, NULL, NULL, NULL, '2025-07-31', 20000, '2025-09-30', '2024-10-31', '2024-11-29', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ARRAY['https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/92f8a652d_NISSANVERSASILVER2020.png'], NULL, NULL, NULL, NULL, 50.0, 1800.0, 'Good', NULL, NULL, '2024-02-25', 'MEXICO', 'MOHSIN ALI ZULIFQAR ALI', '2140113865', 'DUBAI'),
  ('E/36249', 'NISSAN', 'ALTIMA SE', 'SE', 2020, '1N4BL4CV2LC244742', NULL, 'Automatic', 'Petrol', 'ORANGE', '1N4BL4CV2LC244742', 'Sedan', 250000, 'Manual', 5, 4, 'Economy', NULL, 'Available', 'Dubai', 'Al nahda', NULL, '2025-02-12', 40000.0, 35000.0, 'Owned', NULL, NULL, 'DXB-MVA-2025-03', '2026-03-21', NULL, '2026-02-21', NULL, NULL, NULL, NULL, '2025-07-31', 15000, '2025-10-31', '2025-04-30', '2025-03-26', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ARRAY['https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/19782052b_NISSANALTIMASEORANGE2020.png'], NULL, NULL, NULL, NULL, NULL, NULL, 'Good', NULL, NULL, '2025-02-25', 'AMERICA', 'MOHSIN ALI ZULIFQAR ALI', '2140113865', 'DUBAI'),
  ...
  ('P/56942', 'CHEVROLET', 'MALIBU', NULL, 2019, '1G1ZB5ST9KF224575', NULL, 'Automatic', 'Petrol', 'BLACK', '1G1ZB5ST9KF224575', 'Sedan', 250000, 'Manual', 5, 4, 'Economy', NULL, 'Available', 'Dubai', 'Al nahda', NULL, '2024-09-05', 35000.0, 30000.0, 'Owned', NULL, NULL, '2530004974', '2026-07-25', NULL, '2026-06-25', NULL, NULL, NULL, NULL, '2025-07-31', 10000, '2025-10-31', '2025-06-28', '2025-06-24', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ARRAY['https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/a2849f6c8_ChevroletMALIBUBLACK2019.png'], NULL, NULL, NULL, NULL, 50.0, 1800.0, 'Good', NULL, NULL, '2028-06-25', 'AMERICA', 'MOHSIN ALI ZULIFQAR ALI', '2140113865', 'DUBAI'),
  ('P/63062', 'NISSAN', 'UNKNOWN', NULL, 2020, 'JN8AT2MV5LW110335', NULL, 'Automatic', 'Petrol', 'WHITE', 'JN8AT2MV5LW110335', 'Sedan', 100000, 'Manual', 5, 4, 'Economy', NULL, 'Under Maintenance', 'Dubai', 'Al nahda', NULL, '2025-01-15', 25000.0, 20000.0, 'Owned', NULL, NULL, '2530004973', '2026-07-25', NULL, '2026-06-25', NULL, NULL, NULL, NULL, '2025-07-31', 10000, '2025-10-31', '2025-07-24', '2024-12-15', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ARRAY[]::TEXT[], NULL, NULL, NULL, NULL, 60.0, 2000.0, 'Good', NULL, NULL, '2026-06-25', 'JAPAN', 'MOHSIN ALI ZULIFQAR ALI', '2140113865', 'DUBAI'),
  ('U/61913', 'NISSAN', 'UNKNOWN', NULL, 2018, '5N1AT2MT9JC790860', NULL, 'Automatic', 'Petrol', 'BLACK', '5N1AT2MT9JC790860', 'Sedan', 100000, 'Manual', 5, 4, 'Economy', NULL, 'Sold', 'Dubai', 'Al nahda', NULL, '2024-02-24', 35000.0, 25000.0, 'Owned', NULL, NULL, '2530005028', '2026-06-27', NULL, '2026-07-27', NULL, NULL, NULL, NULL, '2025-07-31', 10000, '2025-10-31', '2025-05-25', '2024-05-24', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ARRAY[]::TEXT[], NULL, NULL, NULL, NULL, 50.0, 1800.0, 'Good', NULL, NULL, NULL, 'AMERICA', 'MOHSIN ALI ZULIFQAR ALI', '2140113865', 'DUBAI'),
  ('Q/38571', 'HONDA', 'CIVIC', NULL, 2020, '19XFC2F81LE007089', NULL, 'Automatic', 'Petrol', 'SILVER', '19XFC2F81LE007089', 'Sedan', 240000, 'Manual', 5, 4, 'Economy', NULL, 'Rented', 'Dubai', 'Al nahda', NULL, '2024-09-19', 40000.0, 35000.0, 'Owned', NULL, NULL, '2530005577', '2026-08-11', NULL, '2026-07-11', NULL, NULL, NULL, NULL, '2025-07-31', 10000, '2025-10-31', '2025-04-17', '2025-07-16', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, ARRAY['https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/265137982_HONDACIVICSILVER2020.png'], NULL, NULL, NULL, NULL, 60.0, 2000.0, 'Good', NULL, NULL, '2014-07-25', 'AMERICA', 'MOHSIN ALI ZULIFQAR ALI', '2140113865', 'DUBAI')
ON CONFLICT DO NOTHING;


-- Import data for employee
INSERT INTO employee (employee_id, name, email, phone, date_of_birth, nationality, gender, address, department, designation, join_date, employment_type, reporting_manager_id, status, base_salary, passport_copy_url, visa_page_url, emirates_id_url, other_documents) VALUES
  ('EMP1001', 'Omar Khalid Hassan', 'omar.hassan@example.com', '+971502345678', '1991-03-15', NULL, 'Male', 'Al Nahda, Dubai', 'Marketing', 'Sales executive', '2025-05-15', 'Full-time', NULL, 'Active', '4000', NULL, NULL, NULL, ARRAY[]::TEXT[]),
  ('EMP1002', 'John Michael Smith', 'john.smith@example.com', '+971551239876', '1990-11-02', NULL, 'Male', NULL, 'Marketing', 'Sales executive', '2025-04-20', 'Full-time', NULL, 'Active', '4000', NULL, NULL, NULL, ARRAY[]::TEXT[]),
  ('EMP1005', 'Ahmed Raza Khan', 'ahmed.khan@example.com', '+971543219876', '1994-12-25', NULL, 'Male', 'Jumeirah Lake Towers, Dubai', 'Operations', 'Driver', '2025-08-11', 'Full-time', NULL, 'Active', '2500', NULL, NULL, NULL, ARRAY[]::TEXT[])
ON CONFLICT DO NOTHING;


-- Import data for shift
INSERT INTO shift (name, start_time, end_time, duration_hours) VALUES
  ('Morning shift', '08:00', '17:30', '9.5'),
  ('Night shift', '17:00', '02:00', '9')
ON CONFLICT DO NOTHING;


-- Import data for lead
INSERT INTO lead (name, email, phone, source, status, assigned_to_id, notes) VALUES
  ('Zhang Wei', 'zhang.wei@example.com', '583214567', 'website', 'New', NULL, NULL),
  ('Zhang Wei', 'zhang.wei@example.com', '567654321', 'website', 'New', NULL, NULL),
  ('Zhang Wei', 'zhang.wei@example.com', '567654321', 'website', 'New', NULL, NULL),
  ('Ahmed Khalid Al Mansoori', 'ahmed.mansoori@example.com', '583214567', 'Social media', 'Won', NULL, NULL)
ON CONFLICT DO NOTHING;
...
INSERT INTO booking (customer_id, vehicle_id, booking_date, start_date, end_date, pickup_location, dropoff_location, total_amount, vat_amount, final_amount, status, payment_status, special_requests) VALUES
  ('68aea75a460af91080ff23a1', '68ae99d4c138a56f61734d43', '2025-08-27', '2025-08-27', '2025-08-29', 'Al nahda', 'Al nahda', '100', NULL, NULL, 'Completed', 'Partial', NULL),
  ('68aeb0146439e3942fa1460e', '68ae9793372d5863b065b486', '2025-08-27', '2025-08-29', '2025-08-30', 'Al qusais', 'Al nahda', '120', NULL, NULL, 'Confirmed', 'Partial', NULL),
  ('68b5735bcb51b0aaf253903d', '68ae91fc9d7c0cabb70c2270', '2025-09-01', '2025-09-03', '2025-09-06', 'business bay', 'business bay', '300', NULL, NULL, 'Pending', 'Pending', 'fuel full'),
  ('6894bbfdab2308e604016a69', '68ae91fc9d7c0cabb70c2270', '2025-09-01', '2025-09-02', '2025-09-05', 'Airport terminal', 'Airport terminal', '300', NULL, NULL, 'Pending', 'Pending', NULL),
  ('6894bbfdab2308e604016a69', '68ae9793372d5863b065b486', '2025-09-01', '2025-09-02', '2025-09-12', 'business bay', 'business bay', '1200', NULL, NULL, 'Pending', 'Pending', NULL),
  ('68b5ab5d27d3fa5d4fc1ff19', '68ae9793372d5863b065b486', '2025-09-01', '2025-09-03', '2025-09-12', 'business bay', 'business bay', '1080', NULL, NULL, 'Pending', 'Pending', NULL),
  ('68b5ab8fba7c840aa8f5b445', '68ae983f314bcc9df313f56c', '2025-09-01', '2025-09-02', '2025-10-02', 'business bay', 'business bay', '1800', NULL, NULL, 'Pending', 'Pending', NULL),
  ('68b5b0ea3b9c920553356dfb', '68ae983f314bcc9df313f56c', '2025-09-01', '2025-09-04', '2025-10-10', 'Airport terminal', 'Airport terminal', '2160', NULL, NULL, 'Pending', 'Pending', NULL),
  ('68b5b1108de08182b7d436fb', '68ae99d4c138a56f61734d43', '2025-09-01', '2025-09-02', '2025-09-30', 'business bay', 'business bay', '1400', NULL, NULL, 'Pending', 'Pending', NULL),
  ('68b5b639ad95870195f058b1', '68ae968af73d9093646c9e65', '2025-09-01', '2025-09-02', '2025-09-30', 'Airport terminal', 'Airport terminal', '2800', NULL, NULL, 'Pending', 'Pending', NULL),
  ('68b5bc39efab9c1fba4461a6', '68ae930cdf09521d6f4b1593', '2025-09-01', '2025-09-02', '2025-09-23', 'business bay', 'business bay', '1050', NULL, NULL, 'Pending', 'Pending', NULL)
ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_document (vehicle_id, document_type, document_name, file_url, file_type, upload_date, expiry_date, extracted_data, notes, is_verified) VALUES
  ('68ae945c26f52dc5d9d75231', 'Mulkia', 'M 61477.pdf', 'https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/3d5794d60_M61477.pdf', 'application/pdf', '2025-08-27', NULL, NULL, NULL, NULL),
  ('68ae945c26f52dc5d9d75231', 'Insurance', 'ContractorAccessPermit_12-06-2025_5254637.pdf', 'https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/cf2b60e60_ContractorAccessPermit_12-06-2025_5254637.pdf', 'application/pdf', '2025-08-27', NULL, NULL, NULL, NULL),
  ('68ae930cdf09521d6f4b1593', 'Mulkia', 'mulikia', 'https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/1b0ddd80b_F20428.pdf', 'pdf', '2025-08-29', NULL, NULL, NULL, NULL)
ON CONFLICT DO NOTHING;
...
INSERT INTO customer_document (customer_id, document_type, document_part, file_name, file_url, expiry_date, is_verified) VALUES
  ('68ae9fb900fa9d9908d4ac28', 'Driving License', 'Front', 'DL Ahmed khalid al mansoori', 'https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/64070d005_NISSANVERSASILVER2020.png', NULL, NULL),
  ('68ac09adbf62389457936561', 'Emirates ID', 'Front', 'emirated ID', 'https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/65d584b16_NISSANPATHFINDERWHITE2020.png', '2026-05-27', NULL),
  ('68ac09adbf62389457936561', 'Emirates ID', 'Front', 'emirated ID', 'https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/26bb110dd_ChevroletMALIBUBLACK2019.png', '2026-08-18', NULL),
  ('68aec36851d59bf33329cb25', 'Driving License', 'Front', 'test', 'https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/d1b8e46aa_NISSANPATHFINDERWHITE2020.png', '2026-08-01', NULL),
  ('68aec36851d59bf33329cb25', 'Driving License', 'main', 'LEXUS RX 450 H  BLACK 2012', 'https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/3d6441074_LEXUSRX450HBLACK2012.png', '2026-02-05', NULL)
ON CONFLICT DO NOTHING;
...
INSERT INTO attendance (employee_id, date, check_in_time, check_out_time, shift_id, status, working_hours, overtime_hours, notes) VALUES
  ('68aea233e1adeabd85297881', '2025-08-27', '2025-08-27T08:00:00', NULL, '68aea31643d8a6f9989abc6c', 'Present', NULL, NULL, NULL),
  ('68aea2704f1dedb1f6452a6a', '2025-08-27', '2025-08-27T08:00:00', NULL, '68aea31643d8a6f9989abc6c', 'Present', NULL, NULL, NULL),
  ('68aea233e1adeabd85297881', '2025-08-26', '2025-08-26T08:00:00', '2025-08-26T17:30:00', '68aea31643d8a6f9989abc6c', 'Present', NULL, NULL, NULL),
  ('68aea39a2665d8f93acb459f', '2025-08-27', '2025-08-27T07:00:00', NULL, '68aea31643d8a6f9989abc6c', 'Present', NULL, NULL, NULL),
  ('68aea39a2665d8f93acb459f', '2025-08-26', '2025-08-26T17:00:00', '2025-08-26T03:00:00', '68aea3d703a82632bd7a4e98', 'Present', NULL, NULL, NULL)
ON CONFLICT DO NOTHING;
...
INSERT INTO payroll (employee_id, month, year, base_salary, overtime_pay, deductions, net_pay, status, processing_date) VALUES
  ('68aea233e1adeabd85297881', '8', '2025', '4000', NULL, NULL, '4000', 'Processed', '2025-08-27'),
  ('68aea2704f1dedb1f6452a6a', '8', '2025', '4000', NULL, NULL, '4000', 'Processed', '2025-08-27'),
  ('68aea39a2665d8f93acb459f', '8', '2025', '2500', NULL, NULL, '2500', 'Processed', '2025-08-27')
ON CONFLICT DO NOTHING;
...
INSERT INTO leave_request (employee_id, leave_type, start_date, end_date, reason, status, manager_comment, hr_comment) VALUES
  ('68aea2704f1dedb1f6452a6a', 'Sick', '2025-08-25', '2025-08-26', 'Fever', 'Approved', NULL, NULL),
  ('68aea39a2665d8f93acb459f', 'Casual', '2025-08-30', '2025-08-30', 'emergency', 'Rejected', NULL, 'emergency'),
  ('68aea2704f1dedb1f6452a6a', 'Sick', '2025-08-29', '2025-08-29', 'sick', 'Approved', NULL, NULL)
ON CONFLICT DO NOTHING;
...
INSERT INTO quotation (customer_id, lead_id, vehicle_details, daily_rate, start_date, end_date, total_amount, validity_date, terms_and_conditions, status, sales_rep_id) VALUES
  ('68b1ac7c9db3dc161f0606e6', NULL, 'Versa', '100', '2025-08-29', '2025-08-30', '200', '2025-08-31', 'Standard rental terms and conditions apply.', 'Draft', NULL),
  ('68b1ac7c9db3dc161f0606e5', NULL, 'Versa', '150', '2025-08-29', '2025-08-30', '300', '2025-08-29', 'Standard rental terms and conditions apply.', 'Rejected', NULL),
  ('68b1ac7c9db3dc161f0606e8', NULL, 'toyota', '100', '2025-08-29', '2025-08-29', '100', '2025-08-29', 'Standard rental terms and conditions apply.', 'Sent', NULL),
  ('68b1ac7c9db3dc161f0606e8', NULL, 'toyota', '100', '2025-08-29', '2025-08-29', '100', '2025-08-29', 'Standard rental terms and conditions apply.', 'Accepted', NULL)
ON CONFLICT DO NOTHING;
...
INSERT INTO interaction_log (customer_id, lead_id, type, notes, sales_rep_id, date) VALUES
  ('6891f61474e44b72f43af76c', NULL, 'Note', 'test2', '6891f57922e817b10a5d63fc', '2025-08-07T12:00:34.136Z'),
  ('6891f61474e44b72f43af76c', NULL, 'Note', 'Test', '6891f57922e817b10a5d63fc', '2025-08-07T12:00:08.606Z'),
  ('68960bc5f83ba19134972b7e', NULL, 'Note', 'aa', '6891f57922e817b10a5d63fc', '2025-08-11T08:53:43.590Z'),
  ('68960bc5f83ba19134972b7e', NULL, 'Note', 'a
a
a
a
a
...
a', '6891f57922e817b10a5d63fc', '2025-08-11T08:53:36.249Z'),
  ('68960bc5f83ba19134972b7e', NULL, 'Note', 'aaa', '6891f57922e817b10a5d63fc', '2025-08-11T08:53:59.740Z')
ON CONFLICT DO NOTHING;
...
INSERT INTO invoice (invoice_number, client_id, client_name, invoice_date, due_date, amount, tax, status, notes, payment_id, booking_id) VALUES
  ('INV-2025-21536', '68aea75a460af91080ff23a1', 'Unknown Customer', '2025-08-27', '2025-08-28', '100', '5', 'Paid', NULL, NULL, '68aea75ae2fafcaf3f4e5423'),
  ('INV-2025-17091', '68aeb0146439e3942fa1460e', 'Michael Andrew Smith', '2025-08-31', '2025-09-15', '120', '5', 'Unpaid', 'Invoice for Booking #3D92EB71', NULL, '68aeb015ca180cd93d92eb71'),
  ('INV-2025-63474', '68b5735bcb51b0aaf253903d', 'Lexus Auto LLC', '2025-09-01', '2025-09-16', '300', '5', 'Unpaid', 'Invoice for Booking #14C1F384', NULL, '68b5735be927eb2a14c1f384'),
  ('INV-2025-88026', '6894bbfdab2308e604016a69', 'Roosewalt Pereira', '2025-09-01', '2025-09-16', '300', '5', 'Unpaid', 'Invoice for Booking #4CE0838C', NULL, '68b58d984fc066404ce0838c'),
  ('INV-1756730056527', '6894bbfdab2308e604016a69', 'Roosewalt Pereira', '2025-09-01', '2025-10-01', NULL, NULL, 'Sent', 'Invoice for Booking #EB0ECC82', NULL, '68b5901a3ae26899eb0ecc82'),
  ('INV-1756736447807', '68b5ab8fba7c840aa8f5b445', 'DDD trading LLC', '2025-09-01', '2025-10-01', NULL, NULL, 'Draft', 'Invoice for Booking #9DB71405', NULL, '68b5ab8f87f6a5a29db71405'),
  ('INV-1756737440787', '68b5ab5d27d3fa5d4fc1ff19', 'Amazon Corp', '2025-09-01', '2025-10-01', NULL, NULL, 'Draft', 'Invoice for Booking #05390BFF', NULL, '68b5ab5df3db7a6405390bff'),
  ('INV-1756737868373', '68b5b1108de08182b7d436fb', 'ABCD LLC', '2025-09-01', '2025-10-01', NULL, NULL, 'Draft', 'Invoice for Booking #53356FBC', NULL, '68b5b1113b9c920553356fbc'),
  ('INV-1756738388091', '68b5b0ea3b9c920553356dfb', 'Google enterprises', '2025-09-01', '2025-10-01', NULL, NULL, 'Draft', 'Invoice for Booking #E48F3F8B', NULL, '68b5b0eb3f1c0093e48f3f8b'),
  ('INV-1756739156014', '68b5b639ad95870195f058b1', 'Google enterprises', '2025-09-01', '2025-10-01', NULL, NULL, 'Draft', 'Invoice for Booking #CACBE81B', NULL, '68b5b639a62fb8cccacbe81b'),
  ('INV-1756740683249', '68b5bc39efab9c1fba4461a6', 'Amazon Corp', '2025-09-01', '2025-10-01', NULL, NULL, 'Draft', 'Invoice for Booking #BF49053F', NULL, '68b5bc3a08d462b4bf49053f')
ON CONFLICT DO NOTHING;
...
INSERT INTO maintenance_log (vehicle_id, service_date, odometer_reading, service_type, vendor, cost, report_url, notes, next_service_due_date, status) VALUES
  ('68ae945c26f52dc5d9d75231', '2025-08-27', '245015', 'Inspection', NULL, '250', NULL, NULL, '2025-10-31', 'Upcoming'),
  ('68ae968af73d9093646c9e65', '2025-08-27', '125456', 'Repair', NULL, '300', NULL, NULL, '2025-08-27', 'Upcoming')
ON CONFLICT DO NOTHING;
...
INSERT INTO incident_log (vehicle_id, incident_date, type, severity, description, photo_urls, responsible_user_id, status) VALUES
  ('68ae945c26f52dc5d9d75231', '2025-08-27T09:41', 'Mechanical Issue', 'Medium', 'Breakdown', ARRAY[]::TEXT[], NULL, 'Resolved'),
  ('68ae945c26f52dc5d9d75231', '2025-08-27T09:42', 'Mechanical Issue', 'Medium', 'Breakdown', ARRAY['https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/8f375d216_WhatsAppImage2025-08-22at21538PM.jpeg'], NULL, 'Resolved'),
  ('68ae99323aed0b8a572b3225', '2025-08-27T09:57', 'Mechanical Issue', 'Low', 'Tyre puncture', ARRAY['https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/a1a9373d9_NISSANALTIMASEORANGE2020.png'], NULL, 'Under Review'),
  ('68ae930cdf09521d6f4b1593', '2025-08-29T00:00:00.000Z', 'Accident', 'Low', 'breakdown', ARRAY['https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/863242177_NISSANPATHFINDERWHITE2020.png'], NULL, 'Resolved'),
  ('68ae99d4c138a56f61734d43', '2025-08-29T16:00:00.000Z', 'Mechanical Issue', 'Critical', 'breakdown', ARRAY['https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/cb4d94844_NISSANVERSASILVER2020.png'], NULL, 'Resolved')
ON CONFLICT DO NOTHING;
...
INSERT INTO vehicle_contract (vehicle_id, customer_name, start_date, end_date, contract_value, payment_terms, document_url, status, booking_id) VALUES
  ('68ae91fc9d7c0cabb70c2270', 'Ahmed Khalid Al Mansoori', '2025-08-27', '2025-09-17', '2500', '50% advance', NULL, 'Active', NULL),
  ('68ae91fc9d7c0cabb70c2270', 'Ahmed Khalid Al Mansoori', '2025-09-17', '2026-09-17', '2500', '50% advance', NULL, 'Active', NULL),
  ('68ae930cdf09521d6f4b1593', 'Test booking', '2025-08-29', '2025-10-29', '3000', NULL, 'https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/83ad19a94_AlJisrCarRentals-CompleteAPISpecification.pdf', 'Expired', NULL)
ON CONFLICT DO NOTHING;
...
INSERT INTO staff_document (employee_id, document_type, document_name, file_url, file_type, upload_date, expiry_date, description, is_confidential, is_verified) VALUES
  ('68aea2704f1dedb1f6452a6a', 'Employment Contract', 'Contract test', 'https://base44.app/api/apps/6891f57922e817b10a5d63fb/files/798974d01_toclaideforsuggestions.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', '2025-08-30', NULL, NULL, 'true', NULL)
ON CONFLICT DO NOTHING;
...
SELECT table_name, COUNT(*) as record_count FROM (
  ...
  SELECT 'deduction' as table_name, COUNT(*) FROM deduction UNION ALL
  SELECT 'quotation' as table_name, COUNT(*) FROM quotation UNION ALL
  SELECT 'marketing_campaign' as table_name, COUNT(*) FROM marketing_campaign UNION ALL
  ...
  SELECT 'fine_log' as table_name, COUNT(*) FROM fine_log UNION ALL
  SELECT 'car_image' as table_name, COUNT(*) FROM car_image UNION ALL
  SELECT 'agreement' as table_name, COUNT(*) FROM agreement UNION ALL
